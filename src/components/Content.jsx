...
class Content extends React.Component {
  render() {
    return (
      <div class="content">
        <h1>Heading of the Feature</h1>
        <p>Welcome to the Trimble Connect for Browser's 3D Viewer User Guide. In this guide you will find useful information on using the 3D Viewer in Trimble Connect.
        You can perform several different tasks while working in the 3D Viewer. Below is a reference guide which shows the icons used in the 3D View and which page you can go to learn more about it.
        </p>
